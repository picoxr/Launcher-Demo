...
{	
	...
	static String USE_VERTEX_COLOR = "USE_VERTEX_COLOR";
	...
	void initModes(Material m){
		...
		useVertexColors = m.IsKeywordEnabled (USE_VERTEX_COLOR);
	}
	...
	public override void OnGUI (MaterialEditor me, MaterialProperty[] props) {
		...
		Toggle (USE_VERTEX_COLOR, 0, 0, ref useVertexColors, 120, "Vertex Color");
