...
/// <summary>
/// KEY,zh,en,ja,fr,de,it,es
/// Language,中文,English,日本語,Français,Deutsch,In Italiano,El español
/// </summary>

public static class Localization
{
    static public System.Action LanguageChangeAction;
	...
	static public string language
	{
		get
		{
            if (string.IsNullOrEmpty(mLanguage))
			{
				...
				mLanguage = PlayerPrefs.GetString("Language", lan != null ? lan[0] : "en");
